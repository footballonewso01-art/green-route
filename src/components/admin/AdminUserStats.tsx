  ...
  return <div className="min-w-0 space-y-6">
    ...
    {editing && <DashboardPanel id="stats-adjustment-editor" className="space-y-6 p-4 sm:p-6">
      ...
      {preview && <div className="space-y-5 border-t border-border pt-6" aria-label="Adjustment preview">
        ...
        <p className="text-xs leading-relaxed text-muted-foreground">{preview.summary.estimated ? "The hourly distribution is estimated with varying daily rhythms and occasional traffic bursts. " : "The estimated hourly distribution follows recorded daily activity without replaying individual visits or spikes. "}{preview.summary.geographyEstimated ? "Geography is estimated. " : "Geography follows the recorded distribution. "}Generating a fresh preview creates a new distribution while preserving the exact total. Unique share is an estimate. Profile views and link clicks remain separate; existing card-attribution shares are preserved. Recent activity continues to show only recorded visits. Preview expires in 15 minutes.</p>
